        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHotCategory = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserVictimId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogActives", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LogActives_AspNetUsers_UserActorId",
                        column: x => x.UserActorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LogActives_AspNetUsers_UserVictimId",
                        column: x => x.UserVictimId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LogActives_UserActorId",
                table: "LogActives",
                column: "UserActorId");

            migrationBuilder.CreateIndex(
                name: "IX_LogActives_UserVictimId",
                table: "LogActives",
                column: "UserVictimId");
